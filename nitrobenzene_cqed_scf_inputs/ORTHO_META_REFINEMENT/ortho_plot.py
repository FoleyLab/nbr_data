...
# --- Configuration ---
DATA_FILE = "ortho_meta_refinement_scan.txt"
OUTPUT_IMAGE = "ortho_meta_difference_surface.png"
...
cbar.set_label(r"$\Delta E$ (Ortho - Meta) [kcal/mol] (Relative)", fontsize=12)
...
# Aesthetics
plt.title(r"Energy Surface Refinement: Ortho vs Meta", fontsize=14, pad=15)
