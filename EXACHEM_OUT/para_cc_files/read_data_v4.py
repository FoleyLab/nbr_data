...
# === USER SETTINGS ===
HOMEDIR = os.path.expanduser("~")      # or set explicitly if needed
INPUT_DIR = "/global/cfs/projectdirs/m4262/mapol/exachem-dev/inputs/ci/NB_QED_RHF_INPUTS/SUB_META_PARA/para_cc_files"                       # where your .json input files live
