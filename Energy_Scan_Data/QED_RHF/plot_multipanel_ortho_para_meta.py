...
# --- Configuration ---
FILE_NAME = "nitrobromo_cqedrhf_field_scan_combined.txt"
...
def plot_energy_diffs():
    ...
    plt.suptitle('Comparison of Orientational Energy Landscapes [QED-RHF]', fontsize=16, fontweight='bold')
    
    # 4. Save and Show
    plt.savefig("energy_difference_maps_cqedrhf.png", dpi=DPI)
