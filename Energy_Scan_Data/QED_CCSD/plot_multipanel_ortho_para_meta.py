...
def plot_energy_diffs():
    ...
    plt.suptitle('Comparison of Orientational Energy Landscapes [QED-CCSD(2,2)]', fontsize=16, fontweight='bold')
    
    # 4. Save and Show
    plt.savefig("energy_difference_maps_ccsd_22.png", dpi=DPI)
