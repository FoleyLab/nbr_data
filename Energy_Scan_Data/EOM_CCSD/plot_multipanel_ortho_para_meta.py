...
# --- Configuration ---
FILE_NAME ="isomer_total_energies.dat" #"CCSD_Combined_Results.txt"
...
def plot_energy_diffs():
    ...
    fig.colorbar(im1, ax=ax1, label='Energy Difference (kcal / mol)')
    ...
    fig.colorbar(im2, ax=ax2, label='Energy Difference (kcal / mol)')
    ...
    plt.suptitle('Comparison of Orientational Energy Landscapes [pQED(45,2)]', fontsize=16, fontweight='bold')
    
    # 4. Save and Show
    plt.savefig("energy_difference_maps_pQED_EOM-CCSD_Nel_45_Nph_2.png", dpi=DPI)
